...
class Customers():
  ...
  def __init__(self,
    ...
    lats = (
        self.extents['llcrnrlat'] + np.random.randn(num_stops) *
...
<<<<<<< HEAD
    ...
    def central_start_node(self, invert=False):
        """
=======
>>>>>>> e226e523a99a0539ddfffa68597d1cae8a7cb946
...
>>>>>>> e226e523a99a0539ddfffa68597d1cae8a7cb946
  ...
  if assignment:
    ...
    for veh in range(vehicles.number):
      vehicle_routes[veh] = build_vehicle_route(routing, assignment, customers,
                                                veh)
